# backend/api/appointments.py - COMPLETE REPLACEMENT
...
@router.get("/search", response_model=List[AppointmentResponse])  # Removed trailing slash
...
@router.get("/all", response_model=List[AppointmentResponse])  # Removed trailing slash
